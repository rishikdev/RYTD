export default [
  {
    ...
    card_text:
      "Want to know how many dislikes a YouTube video has to help you gauge its usefulness? With the RYTD Safari extension, you can easily see the dislike count directly on the video page! Once installed, the extension displays the dislike number right next to the dislike button—no need to copy and paste URLs or use any extra tools. It's a seamless, hassle-free way to get a better sense of a video's reception while browsing YouTube. Try it out and make smarter viewing choices today!",
  },
